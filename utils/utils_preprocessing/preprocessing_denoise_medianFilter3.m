%Use 3D median filter to denoise input image sequence
%%ELiiiiiii, 20210916
function inputStack = preprocessing_denoise_medianFilter3(inputStack,bacthSizeArray)
%% inputs:
%     inputStack: 3D stack
...
%% 3d median filter
inputStack = medfilt3(inputStack,bacthSizeArray);
end